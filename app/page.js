...
function Hero() {
  return (
    <div className="flex flex-col items-center justify-center gap-4">
      ...
      <Button variant="contained" href="/news" endIcon={<ArrowForwardOutlinedIcon />}>查看最新消息</Button>
      <Divider flexItem />
    </div>
  );
}
...
function HighlightedFood() {
  return (
    <div className="flex  flex-col items-center justify-center py-4 gap-4">
      ...
      <Button variant="contained" href="/menu" endIcon={<ArrowForwardOutlinedIcon />}>去看菜單</Button>
      <Divider flexItem />
    </div>
  );
}
